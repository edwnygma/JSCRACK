...
<div class='teaser music_teaser odd n1 first' id='albums_teaser'>
<div class='teaser_heading'>Featured CDs</div>
<div class='teaser_content'><div class='teaser_entry'>
<a href='/albums/?id=13'><img src='/@/Albums/_albums/13/img1-sm.jpg' alt='' class='album_image image1' /></a>
<div class='teaser_title'>The Rabbit of Seville</div>
<div class='teaser_price'>$0.99 <span class='shipping-handling'>+S&ampH</span></div>
<div class='playall_link'><a href='javascript:void(0);' onclick='javascript:playAudio("/albums/playlist?a=13");return false;'>Play</a></div>
<div class='teaser_buylink'>
<form method='p.st' onsubmit='this.target="paypal"' action='https://www.paypal.com/cgi-bin/webscr'>
<div>
<input type='hidden' name='cmd' value='_cart' />
<input type='hidden' name='business' value='rob@robgravelle.com' />
<input type='hidden' name='item_name' value='The Rabbit of Seville' />
<input type='hidden' name='amount' value='0.99' />
<input type='hidden' name='currency_code' value='USD' />
<input type='hidden' name='lc' value='US' />
<input type='hidden' name='add' value='1' />
<input type='image' src='/!/static/cms/images/merch/paypal/add_to_cart.png' alt='Add to Cart' />
</div>
</form>
</div> <!-- div.teaser_buylink -->
<div class='teaser_buylink'>
<a href="http://itunes.apple.com/ca/album/the-rabbit-of-seville/id381410549?uo=4" target="itunes_store"><img src="http://r.mzstatic.com/images/web/linkmaker/badge_itunes-lrg.gif" alt="The Rabbit of Seville - Rob Gravelle" style="border: 0;"/></a></div> <!-- closes div.itunes -->
</div>

<div class='teaser_entry'>
<a href='/albums/?id=11'><img src='/@/Albums/_albums/11/img1-sm.jpg' alt='' class='album_image image1' /></a>
<div class='teaser_title'>Cover: Ballroom Blitz by The Sweet</div>
<div class='teaser_price'>$0.99 <span class='shipping-handling'>+S&ampH</span></div>
<div class='playall_link'><a href='javascript:void(0);' onclick='javascript:playAudio("/albums/playlist?a=11");return false;'>Play</a></div>
<div class='teaser_buylink'>
<form method='post' onsubmit='this.target="paypal"' action='https://www.paypal.com/cgi-bin/webscr'>
<div>
<input type='hidden' name='cmd' value='_cart' />
<input type='hidden' name='business' value='rob@robgravelle.com' />
<input type='hidden' name='item_name' value='Cover: Ballroom Blitz by The Sweet' />
<input type='hidden' name='amount' value='0.99' />
<input type='hidden' name='currency_code' value='USD' />
<input type='hidden' name='lc' value='US' />
<input type='hidden' name='add' value='1' />
...
<div class='teaser_buylink'>
<a href="http://itunes.apple.com/ca/album/ballroom-blitz/id360486756?uo=4" target="itunes_store"><img src="http://r.mzstatic.com/images/web/linkmaker/badge_itunes-lrg.gif" alt="Ballroom Blitz - Rob Gravelle" style="border: 0;"/></a></div> <!-- closes div.itunes -->
</div>


</div>
</div> <!-- div.teaser#albums_teaser -->
...
<script type="text/javascript">
    ...
    with (mainSection.style)
    {
        backgroundImage="url('/@/Storage/_files/68/file.jpg')";
    }

    var elt = document.getElementById('main_heading');
    ...
    {       
        ...
        {
            //id  = 'RobLogo';
            src = '/@/Storage/_files/62/file.gif';
        }
    }
</script>
